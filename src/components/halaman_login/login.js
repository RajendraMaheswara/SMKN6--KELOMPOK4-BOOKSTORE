    ...
    >
      <div className="bg-white-apik w-3/4 h-3/4 rounded-xl grid grid-cols-2">
        <div className="col-span-1">
          ...
          <div className="text-center mt-10 font-bold text--4xl hover:scale-100 duration-300 ">
            <h1>Welcome To Bookstore</h1>
          </div>
          <div className="flex items-center justify-center mt-10">
            <h2 class="font-bold text-4xl text-[#002D74] ">Login</h2>
          </div>
          <div className="flex items-center justify-center mb-5">
            <p class="text-xs mt-8 text-[#002D74]">
          ...
          <div>
            ...
            <div className="px-10">
              <div className="grid grid-cols-3 items-center justify-center gap-50">
                ...
                <div className="col-span-1 flex justify-center hover:scale-110 duration-300">
